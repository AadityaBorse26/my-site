                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-md-end">
                                <div class="social-links">
                                    <a href="https://github.com/AadityaBorse26" class="text-light me-3" target="_blank">
                                        <i class="fab fa-github fa-lg"></i>
                                    </a>
                                    <a href="https://linkedin.com/in/aaditya-borse" class="text-light me-3" target="_blank">
                                        <i class="fab fa-linkedin fa-lg"></i>
                                    </a>
                                    <a href="mailto:aaditya.borse@example.com" class="text-light">
